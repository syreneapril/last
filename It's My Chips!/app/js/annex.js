    ...
    var w = {
        ...
        showWorld: function() {
            if (!this.hasInit) {
                ...
                $('.result_new_p1').html(getMessage('newOneGame', 'NEW 1 PLAYER GAME'));
                $('.result_new_p2').html(getMessage('newTwoGame', 'NEW 2 PLAYERS GAME'));
                ...
                $('.configure_panel_help').click(function(){
                    ...
                    $(this).css('background-color','#000000');
                }).find('.configure_panel_text').html(getMessage('rules','Help'));
        ...
        init: function(play){
            ...
            $('.play1_lable').html(getMessage('player', 'Player ')+'<span style="font-size:20pt;">1</span>');
            if (this.playerNum == 2) {
                $('.play2_lable').html(getMessage('player', 'Player ')+'<span style="font-size:20pt;">2</span>');
            } else {
        ...
        showHelp: function(){
            ...
            if (!this.hasHelp) {
                ...
                $('.help_title').html(getMessage('howtoPlay', ''));
                $('.help_contain').html(getMessage('help', ""));
                $('.help_exit').html(getMessage('goBack', 'Back'));
            }
        ...
        drawMessage: function(){
            ...
            if (!this.isEnd) {
                ...
                if (bc > wc) {
                    ...
                    $('.result_win_text').html(getMessage('winDraw', ' '));
                } else {
                    if (this.playerNum == 2) {
                        $('.result_win_text').html(p+' 2 '+w+'!');
                    } else {
                        $('.result_win_text').html(getMessage('winComputer', ' '));
                    }
                }
...
window.onload = function(){
    ...
    $('title').html(getMessage('name', 'Its My Chips'));
    $('#open1').html(getMessage('1PlayerGame', '1 Player Game'));
    $('#open2').html(getMessage('2PlayerGame', '2 Players Game'))
